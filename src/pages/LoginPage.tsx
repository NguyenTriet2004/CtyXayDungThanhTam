      ...
      >
        ...
        <div className="text-center mb-10">
          <div className="w-16 h-16 border-2 border-gold flex items-center justify-center rotate-45 mx-auto mb-8">
            <span className="text-gold font-serif font-bold text-2xl -rotate-45">
              TT
            </span>
          </div>
          <h1 className="text-3xl font-serif font-bold text-white mb-2 uppercase tracking-widest">
            Đăng Nhập
          </h1>
          <p className="text-stone-500 text-sm italic">
            Hệ thống quản lý khách hàng Thành Tâm
          </p>
        </div>
